# [kong_plugin_request_transformer_advanced](https://github.com/alexashley/terraform-provider-kong/tree/master/kong/provider/resource_kong_plugin_request_transformer_advanced.go)
